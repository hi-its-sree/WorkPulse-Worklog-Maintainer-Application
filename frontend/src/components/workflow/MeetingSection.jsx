          ...
          <div key={`meeting-${index}`} className="rounded-[24px] border border-[var(--border-subtle)] bg-[var(--surface-secondary)] p-5">
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              <label className="block text-sm text-[var(--text-secondary)]">
                ...
                <input value={meeting?.title ?? ''} onChange={(e) => onUpdateMeeting(index, 'title', e.target.value)} className="app-input mt-2" placeholder={strings.planner.placeholders.meetingName} />
              </label>
              <label className="block text-sm text-[var(--text-secondary)]">
