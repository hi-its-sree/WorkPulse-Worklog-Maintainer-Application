...
const TaskTimeCard = ({ task, project, hours, category, date, status, completionPercent, accent }) => {
  ...
  const normalizedStatus = (status || strings.common.statuses.inProgress).toString();
    ...
    >
      ...
      <div className="mt-4 flex items-end justify-between gap-3">
        ...
        <div className="text-right">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>{strings.timesheet.taskCard.timeSpent}</p>
        </div>
      </div>
